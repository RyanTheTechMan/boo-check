...
const fields = {
  ...
  fourChanTagMode: document.getElementById("fourChanTagModeSetting") as HTMLSelectElement,
...
function renderSettings(settings: AppSettings): void {
  ...
  fields.fourChanTagMode.value = settings.fourChanTagMode;
...
async function persistSettings(): Promise<void> {
  const settings = normalizeSettings({
    ...
    fourChanTagMode: fields.fourChanTagMode.value as AppSettings["fourChanTagMode"],
